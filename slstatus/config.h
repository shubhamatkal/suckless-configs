...
static const struct arg args[] = {
	...
	{run_command, "TEMP:%s | ", "sensors | awk '/^Tctl/ {print $2}'"},
	{ram_perc , "RAM:%s | ", NULL},
	{cpu_perc, "CPU:%s | ", NULL},
	{run_command, "FAN: %s | ","sensors | grep 'fan1:' | awk '{if ($2 == \"0\") print \"OFF\"; else print $2 \" \" $3}'"},
	...
	{run_command, "%s | ","sh /home/shubham/scripts/weather.sh"},
